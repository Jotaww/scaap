...
<div class="container">
  ...
  <hr>
  <form class="ms-1" id="form" enctype="multipart/form-data" action="/scaap/admin/editar/{{$user->id_user}}" method="post">
    @csrf
    @method('put')
              ...
              @foreach ($segmentos as $segmento)
                ...
                <tr>
                  <td class="tdTable ps-3 pe-3">
                    ...
                    <a href="/scaap/admin/editar/form/{{$user->id_user}}/delete/{{$segmento->id_segmento}}"><i id="trash" class="bi bi-trash trash"></i></a>
                  </td>
                </tr>
                @endif
              @endforeach
          ...
          @if ($user->id_user == $anexo->id_user && $anexo->tipo == 1)
            <tr>
              <td class="d-flex justify-content-between ps-3 pe-3">
                  ...
                  <a href="/scaap/admin/editar/form/{{$user->id_user}}/anexo/delete/{{$anexo->id}}"><i id="trash" class="bi bi-trash trash"></i></a>
              </td>
            </tr>
          @endif
          @endforeach
