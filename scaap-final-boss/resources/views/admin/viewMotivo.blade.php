...
<div class="container">
  ...
  <hr class="mt-5 mb-5">
  <h3 class="ps-3 mb-3">Motivo</h3>
  <form action="/scaap/admin/reprovar/{{$user->id_user}}" method="post">
    @csrf
    @method('put')
    <div class="form-floating">
      <textarea class="form-control" disabled name="motivo" placeholder="Leave a comment here" id="floatingTextarea" style="height: 150px">{{$user->motivo}}</textarea>
    </div>
  </form>
</div>
